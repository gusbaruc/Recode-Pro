        ...
        <div className="Formatacao">
          <form>
            ...
            <select>
              ...
              <option value="Subtrair" onClick={this.subtracao}>Subtrair</option>
              <option value="Dividir" onClick={this.divisao}>Dividir</option>
              <option value="Multiplicar" onClick={this.multiplicacao}>Multiplicar</option>
            </select>
            <br/><br/>
